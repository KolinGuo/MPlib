...
void build_pypinocchio(py::module &m_all) {
  ...
  PyPinocchioModel
      ...
      .def("compute_forward_kinematics",
           &PinocchioModel::computeForwardKinematics, py::arg("qpos"))
      ...
      .def("get_link_jacobian", &PinocchioModel::getLinkJacobian,
           py::arg("index"), py::arg("local") = false)
      ...
      .def("compute_IK_CLIK", &PinocchioModel::computeIKCLIK, py::arg("index"),
           py::arg("pose"), py::arg("q_init"),
           py::arg("mask") = std::vector<bool>(), py::arg("eps") = 1e-5,
           py::arg("maxIter") = 1000, py::arg("dt") = 1e-1,
           py::arg("damp") = 1e-12)
      .def("compute_IK_CLIK_JL", &PinocchioModel::computeIKCLIKJL,
           py::arg("index"), py::arg("pose"), py::arg("q_init"),
           py::arg("q_min"), py::arg("q_max"), py::arg("eps") = 1e-5,
           py::arg("maxIter") = 1000, py::arg("dt") = 1e-1,
           py::arg("damp") = 1e-12)
      .def("get_joint_names", &PinocchioModel::getJointNames,
           py::arg("user") = true)
      .def("get_link_names", &PinocchioModel::getLinkNames,
           py::arg("user") = true)
      .def("get_leaf_links", &PinocchioModel::getLeafLinks)
      .def("get_joint_dim", &PinocchioModel::getJointDim, py::arg("index"),
           py::arg("user") = true)
      .def("get_joint_dims", &PinocchioModel::getJointDims,
           py::arg("user") = true)
      .def("get_joint_ids", &PinocchioModel::getJointIds,
           py::arg("user") = true)
      .def("get_parents", &PinocchioModel::getParents, py::arg("user") = true)
      .def("get_joint_types", &PinocchioModel::getJointTypes,
           py::arg("user") = true)
      .def("get_joint_limits", &PinocchioModel::getJointLimits,
           py::arg("user") = true)
